...
__attribute__((section("__versions"))) = {
	...
	{ 0x1e677c75, __VMLINUX_SYMBOL_STR(eth_commit_mac_addr_change) },
	{ 0x7c234f5d, __VMLINUX_SYMBOL_STR(eth_prepare_mac_addr_change) },
...
MODULE_INFO(srcversion, "174380806F49BA1D1967C70");
