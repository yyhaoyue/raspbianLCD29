...
__attribute__((section("__versions"))) = {
	...
	{ 0x8b97fe7c, __VMLINUX_SYMBOL_STR(usb_wwan_chars_in_buffer) },
	{ 0x9a04c086, __VMLINUX_SYMBOL_STR(usb_wwan_write_room) },
...
MODULE_INFO(srcversion, "1FEBE11AADF0878C6B520DD");
