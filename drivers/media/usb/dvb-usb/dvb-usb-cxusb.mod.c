...
__attribute__((section("__versions"))) = {
	...
	{ 0x990d7030, __VMLINUX_SYMBOL_STR(dib0070_wbd_offset) },
	...
	{ 0xc2142bef, __VMLINUX_SYMBOL_STR(usb_cypress_load_firmware) },
...
MODULE_INFO(srcversion, "D632745B32C05A1357A531E");
