...
__attribute__((section("__versions"))) = {
	...
	{ 0x7730a387, __VMLINUX_SYMBOL_STR(dma_buf_fd) },
	{ 0xc59e4a83, __VMLINUX_SYMBOL_STR(dma_buf_put) },
	{ 0xa1c76e0a, __VMLINUX_SYMBOL_STR(_cond_resched) },
	{ 0xc060d734, __VMLINUX_SYMBOL_STR(dma_buf_get) },
...
MODULE_INFO(srcversion, "880FFD663578B3B396B3B90");
