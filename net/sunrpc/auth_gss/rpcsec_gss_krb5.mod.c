...
__attribute__((section("__versions"))) = {
	...
	{ 0x6bba22d2, __VMLINUX_SYMBOL_STR(gss_mech_register) },
	{ 0xf8b2ff6e, __VMLINUX_SYMBOL_STR(g_verify_token_header) },
	{ 0xa0585896, __VMLINUX_SYMBOL_STR(xdr_buf_subsegment) },
	...
	{ 0x2868b2bf, __VMLINUX_SYMBOL_STR(gss_mech_unregister) },
...
MODULE_INFO(srcversion, "1513813A3D2A4ACBE5EFCE7");
