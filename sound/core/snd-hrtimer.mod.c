...
__attribute__((section("__versions"))) = {
	...
	{ 0xe57282d2, __VMLINUX_SYMBOL_STR(snd_timer_global_new) },
	...
	{ 0x8aae8bde, __VMLINUX_SYMBOL_STR(snd_timer_global_register) },
	{ 0x3eae5d00, __VMLINUX_SYMBOL_STR(hrtimer_try_to_cancel) },
	{ 0xd7411e9d, __VMLINUX_SYMBOL_STR(snd_timer_global_free) },
};
...
MODULE_INFO(srcversion, "E875ADC17DAC50A985C98E6");
